...
containerDiv.innerHTML = `
<img src="/${user2.coverPhotoURL}" id="coverphoto"/>
<div class='under-cover'>
  <div class='left-hand-side'>
      <img src="/${user2.avatarURL}"id="main-avatar-photo"/>
      <div id="headernamecont">
          <h1 id="headername">${user2.displayName}</h1>  
          <img src="/assets/Twitter_Verified_Badge.png"id="verified"/>
      </div>
      <p id="username">${user2.userName}</p>
  </div>
  <button class='btn btn-following'>Following</button>
  <button class='btn btn-unfollow'>Unfollow</button>
  <button class='btn btn-follow'>Follow</button>
...
<div class="joined">
<img src="/assets/calendar.png" id='calendar'><p>Joined ${user2.joinedDate}</p> 
</div>
<div id="follow-section">
<span>${user2.followingCount}</span><p>Following</p>
<span>${minifiedFollowerCount()}</span><p>Followers</p>
</div>
`
...
user2.tweets.forEach(function (tweets, i) {
  var individualTweetContainer = document.createElement('div');
  individualTweetContainer.innerHTML = `
  <div class="tweet-container">
